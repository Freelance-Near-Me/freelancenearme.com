...
class Findtalents extends MX_Controller {
    ...
    public function index() {
        ...
        $data['srch_param']['q'] = $data['srch_param']['term'];
		$data['country'] = $data['srch_param']['ccode'];
		$data['city'] = $data['srch_param']['city'];
		$data['sub_skill_id'] = $data['srch_param']['sub_skill_id'];
		$data['skill_id'] = $data['srch_param']['skill_id'];
		$data['memplan'] = $data['srch_param']['memplan'];
		$data['offset'] = 6;
