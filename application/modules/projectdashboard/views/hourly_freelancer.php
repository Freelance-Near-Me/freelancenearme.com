       ...
       <div id="enquiry_form">
            ...
            <div class="form-group">
                ...
                <div class='input-group datepicker'>
                    <input type='text' class="form-control" placeholder="Start date" required name="start_date" id="tracker_from" value="<?php echo $this->input->get('start_date');?>" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-xs-12">
                <div class='input-group datepicker'>
                    <input type='text' class="form-control" placeholder="End date" required name="to_date" id="tracker_to" value="<?php echo $this->input->get('to_date');?>" />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                  </div>                
