...
<div class="top-setting-bar messages-headline">
    <?php /*?><img src="<?php echo ASSETS.$logo?>" alt="" width="48px" height="48"><?php */?>
    
	<h4><a href="javascript:void(0)" class="backArrow" onclick="showListFragment()"><i class="fas fa-arrow-left"></i></a>
	<?php if($status){ ?>
    <small><i class="status-icon status-online"></i></small>
    <?php } else{ ?>
    <small><i class="status-icon status-offline"></i></small>
    <?php } ?>
	<?php echo ucfirst($sender_fname)." ".ucfirst($sender_lname);?> 
	</h4>
...
<div class="editprofile whiteBg leftWidth" id="output">
...
<div class="message-avatar"><img src="<?php echo ASSETS.$logo?>" alt=""></div>
...
<textarea type="text" id="message" name="message" class="form-control" placeholder="Write your message here"></textarea>

<!--<span class="btn btn-default"><i class="icon-material-outline-attach-file"></i>
<input type="file" name="attachment" id="file_chooser">
</span>-->
<div class="uploadButton mr-3 margin-bottom-0" style="width:auto">
...
<button type="submit" name="submit" id="newsubmit" class="btn btn-site" title=""><i class="icon-line-awesome-paper-plane-o"></i></button>
...
<div class="col-sm-4 col-xs-12 hidden-xs d-none" id="files_list">
<div class="col-3-outer">
