...
<div class="spacer-20"></div>
	...
	<ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a href="<?php echo VPATH;?>myfinance"><?php echo __('myfinance_withdraw_fund','Withdraw Fund'); ?></a></li>
        ...
        <li class="nav-item"><a class="active" href="<?php echo VPATH;?>membership/"> <?php echo __('myfinance_membership','Membership'); ?></a></li>
	</ul>           
          <!--EditProfile Start-->
