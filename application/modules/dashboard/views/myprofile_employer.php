		...
		<div class="left-side">
            ...
            <?php } ?>
                ...
                <div class="header-details">
                    <h3><?php echo $fname." ".$lname;?> <a href="#" data-toggle="modal" data-target="#overviewModal"><i class="icon-feather-edit-2"></i></a> <span><?php echo $slogan?></span></h3>
                    <ul>
                        <li>
						<?php
						$avg_rating=0;
                    ...
                    <a href="javascript:void(0)" class="btn btn-sm btn-site" onclick="$('#profileModal').modal('show');"><i class="icon-feather-edit-3"></i> Profile Photo</a>                    <a href="javascript:void(0)" class="btn btn-sm btn-web" onclick="$('#coverModal').modal('show');"><i class="icon-feather-edit-3"></i> Cover Photo</a>
                </div>
            </div>
        </div>		
	</div>
...
<div class="row">    
    ...
    <div class="listing"> 	        
        ...
        <div class="panel-heading" style="overflow: hidden;">        	
        	<h4 class="block-title float-left"><?php echo __('myprofile_emp_job_history','Job History'); ?></h4>
            <a href="<?php echo base_url('postjob')?>" class="float-right btn btn-site"><?php echo __('myprofile_emp_post_job','Post Job'); ?></a>            
        </div>
        <div class="panel-body">
			...
			<table class="table">
				...
				<tr>					
                    <td><a href="<?php echo base_url('jobdetails/details/'.$v['project_id']); ?>"><?php echo (strlen($v['title'])>50) ? substr($v['title'], 0, 50).'...' : $v['title'];?></a></td>
    ...
    <div class="profileEdit margin-bottom-30">                      
     <?php  if($user_id==$user_login) { ?>              
        <a href="<?php echo base_url('findjob')?>" class="btn btn-site btn-lg btn-block hidden"><i class="zmdi zmdi-case"></i> <?php echo __('myprofile_emp_find_job','Find Job'); ?></a>
...
<div class="modal fade" id="skillModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Select Skills</h4>
       ...
       <div class="row-10">
       	<aside class="col-sm-9 col-xs-12">
			...
			<div class="child_skill_wrapper" style="display:none;">
				<a href="javascript:void(0)" onclick="uskill.hideChildPanel(); uskill.showParentPanel();"><i class="fa fa-arrow-left"></i> Back</a>
...
<form id="portfolioForm" onsubmit="dashboard.savePortfolio(this, event);">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="input-group" style="margin-bottom:8px">
        ...
        <label class="input-group-btn">
           <!-- <span class="btn btn-web">
			 ...
			 <span class="btn btn-web">
                Browse&hellip; <input type="file" class="form-control" size="30" name="userfile" onchange="dashboard.uploadPortfolioFile(this)" style="display: none;">
            </span>
        </label>
	...
	jpg, png , jpeg and gif files are allowed.</span>
    </div>
    </div>
...
<div class="modal fade"  id="profileModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Change Profile Picture</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal-footer" id="p_m_footer" style="display:none;">
      <a href="javascript:void(0);" class="btn btn-site" id="crop_image_btn" onclick="pf.cropImage();">Save</a>
    </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-footer" id="pb_m_footer" style="display:none;">
      <a href="javascript:void(0);" class="btn btn-default pull-right" onclick="pf.cropBgImage();">Save</a>
    </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:5%">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
      <h4 class="modal-title" id="myModalLabel"><?php echo __('myprofile_emp_overview','Overviews'); ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        
      </div>
      <div class="modal-body">
       <input type="text" name="fname" value="<?php echo $fname?>" style="margin-bottom: 10px; width: 40%; padding: 5px;">
	   <input type="text" name="lname" value="<?php echo $lname?>" style="margin-bottom: 10px; width: 40%; padding: 5px;">
       <textarea name="overview" class="form-control" rows="6" style="overflow: auto;"><?php echo $overview;?></textarea>
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="portfolioModal" tabindex="-1" role="dialog" aria-labelledby="portmyModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title" id="portmyModalLabel"><?php //echo $val['title'];?></h4>
...
function addExperience(data, exp_id){
	...
	var html = '<div id="experience_'+exp_id+'"><h3>'+edu_data.title+' <a class="pull-right icon-round" data-experience-data=\''+data+'\' data-experience-id="'+exp_id+'" onclick="editExperience(this)" title="Edit"><i class="icon-feather-edit-2"></i></a> <a class="pull-right icon-round" data-experience-id="'+exp_id+'" onclick="deleteExperience('+exp_id+')" title="Delete"><i class="zmdi zmdi-delete"></i></a></h3><p><b>'+edu_data.company+'</b> '+edu_data.start_year+'-'+end+' </p><p>'+edu_data.summary+'</p></div>';
...
function replaceExperience(data, exp_id){
	...
	var html = '<div id="experience_'+exp_id+'"><h4>'+edu_data.title+' <a class="pull-right icon-round" data-experience-data=\''+data+'\' data-experience-id="'+exp_id+'" onclick="editExperience(this)" title="Edit"><i class="icon-feather-edit-2"></i></a> <a class="pull-right icon-round" data-experience-id="'+exp_id+'" onclick="deleteExperience('+exp_id+')" title="Delete"><i class="zmdi zmdi-delete"></i></a></h4><p><b>'+edu_data.company+'</b> '+edu_data.start_year+'-'+end+' </p><p>'+edu_data.summary+'</p></div>';
