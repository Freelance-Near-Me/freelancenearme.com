...
<div class="container">
  <div class="row">
    ...
    <div class="uploadButton">
        ...
        <span class="uploadButton-file-name">Edit Portfolio Images</span>
    </div>                     
       
    </div>
    <img id="loading" src="<?php echo VPATH;?>assets/images/loading.gif" style="display:none;margin:10px;">
   <span style="color:red; display:block"><?php echo __('myprofile_allowed_files','jpg, png , and jpeg files are allowed.'); ?></span> 
    </div>
    </div>
    <div class="masg3" >
