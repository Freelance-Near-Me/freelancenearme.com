...
<div class="row">
    ...
    <select class="form-control" size="1" id="city" name="city" required   />    <option value=""><?php echo __('dashboard_editprofile_select_city','Select City'); ?></option>
    <?php
...
<div class="form-group">
    ...
    <input type="text" class="form-control"  value="<?php echo $gplus_link;?>" name="gplus_link" id="gplus_link"   />
    <div class="focusmsg" id="gplus_linkFocus" style="display:none"><?php echo __('dashboard_editprofile_enter_your_google_plus_url','Enter Your Google Plus Url'); ?> </div>
	<span id="gplusError" class="error-msg13"></span>
</div>

<div class="form-group">
    <label><?php echo __('dashboard_editprofile_linked_in_link','Linkedin Link'); ?> : </label>
    <input type="text" class="form-control"  value="<?php echo $linkedin_link;?>" name="linkedin_link" id="linkedin_link"   />
    <div class="focusmsg" id="linkedin_linkFocus" style="display:none"><?php echo __('dashboard_editprofile_enter_your_linkedin_url','Enter Your Linkedin Url'); ?> </div>
