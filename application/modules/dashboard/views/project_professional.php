...
<div class="dashboard-content-container">
    ...
    <ul class="nav nav-tabs">
    	<li class="nav-item"><a class="active" href="<?php echo VPATH?>dashboard/myproject_professional">My Bid</a></li>
...
<table id="example" class="table" cellspacing="0" width="100%" style="border:none">
...
?>
<tr>
<td><a href="<?php echo VPATH;?>jobdetails/details/<?php echo $val['project_id'];?>"><?php echo $project_name;?> <?php echo $project_status == 'PS' ? ' (Paused) ' : '';?></a></td>
<td><?php echo $type;?></td>
...
<h4 style="margin-top: 40px;">Project Invitations</h4>

<div class="table-responsive">
<table id="example2" class="table" cellspacing="0" width="100%" style="border:none">
<thead><tr><th>Project Name</th><th>Project Type</th><th>Amount</th><th colspan="2">Date</th></tr>
</thead>
<tbody>
<?php
...
<tr>
	...
	<td><a href="#" data-toggle="modal" data-target="#msgModal" data-message="<?php echo $v['message']; ?>" onclick="viewMsg(this);" title="Message"><i class="icon-feather-message-square"></i></a></td>
</tr>
<?php } } ?>	
</tbody>
</table>
