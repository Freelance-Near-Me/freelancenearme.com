...
<div class="clearfix mb-3" style="display:flex; align-items:center">
<h4 class="m-0">CONTESTS</h4>
<div class="text-right" style="flex:1"><a href="<?php echo base_url('contest/post_contest'); ?>" class="btn btn-border">Add Contest</a></div>
</div>
