...
<tr>
    ...
    <th><?php echo __('dashboard_myproject_client_bid_placed','Bid Placed'); ?></th>
    <th><?php echo __('dashboard_myproject_client_action','Action'); ?></th>
    <th style="min-width: 115px;"><?php echo __('dashboard_myproject_posted_date','Posted date'); ?></th>
</tr>
</thead>
<tbody>		
...
?>     
<td><a href="<?php echo VPATH;?>jobdetails/details/<?php echo $val['project_id'];?>"><?php echo (strlen($val['title'])>100) ? substr($val['title'], 0, 100).'...' : $val['title'] ?> (<?php echo $visibility?>)</a></td>
<td>
<?php if($val['project_type']=="F") { echo "<div class='hourly' title='''>
<span class='badge badge-primary'>".__('dashboard_myproject_fixed','Fixed')."</span></div>";} else {
echo "<div class='hourly' title='".__('dashboard_myproject_hourly','Hourly')."'>
<span class='badge badge-info'>".__('dashboard_myproject_hourly','Hourly')."</span></div>"; }?></td>
<td><?php if($val['project_status']=='Y'){echo "<div class='hourly' data-toggle='tooltip' data-placement='top' title=''>
<span class='badge badge-success'>".__('dashboard_myproject_active','Active')."</span></div>";}else{echo "<div class='hourly' title='".__('dashboard_myproject_waiting_for_admin_approval','Awaiting admin approval')."'><i class='fa fa-spinner'></i></div>";}?></td>
...
<a href="javascript:void(0);" class="text-danger" onclick="actionPerform('C',<?php echo $val['id'];?>)" data-toggle="tooltip" title="<?php echo __('dashboard_myproject_close','Close'); ?>"><i class="fa fa-ban"></i></a>
...
<!--EditProfile End-->
<h4 class="title-sm" id='can' style='padding-top:40px'><?php echo __('dashboard_myproject_contracts','Contracts'); ?></h4>

<ul class="nav nav-tabs" role="tablist" id='tab_list'>
	<li role="presentation"><a class="active" href="javascript:void(0)" aria-controls="active" role="tab" data-toggle="tab" id="P" onClick="projectsTabs(this);"><?php echo __('dashboard_myproject_active','Active'); ?></a></li>
	<li role="presentation"><a href="javascript:void(0)" aria-controls="pending" role="tab" data-toggle="tab" id="F" onClick="projectsTabs(this);"><?php echo __('dashboard_myproject_pending','Pending'); ?></a></li>
	<li role="presentation"><a href="javascript:void(0)" aria-controls="pause" role="tab" data-toggle="tab" id="PS" onClick="projectsTabs(this);"><?php echo __('dashboard_myproject_pause','Pause'); ?></a></li>
	<li role="presentation"><a href="javascript:void(0)" aria-controls="expired" role="tab" data-toggle="tab" id="E" onClick="projectsTabs(this);"><?php echo __('dashboard_myproject_expired','Expired'); ?></a></li>
	<li role="presentation"><a href="javascript:void(0)" aria-controls="completed" role="tab" data-toggle="tab" id="C" onClick="projectsTabs(this);"><?php echo __('dashboard_myproject_completed','Completed'); ?></a></li>
	<li role="presentation"><a href="javascript:void(0)" aria-controls="completed" role="tab" data-toggle="tab" id="S" onClick="projectsTabs(this);"><?php echo __('dashboard_myproject_stopped','Stopped'); ?></a></li>
</ul>
...
if($status!=''){
	if($status == 'C'){
		...
		<script>
		$(document).ready(function(){
			$('ul#tab_list li:nth-child(5) a').click();
			$("html, body").animate({
		...
		<script>
		$(document).ready(function(){
			$('ul#tab_list li:nth-child(1) a').click();
			$("html, body").animate({
				scrollTop: $('#can').offset().top
			  }, 1000);
		})
