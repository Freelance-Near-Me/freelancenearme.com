...
?>
          ...
          <input type="button" value="<?php echo __('dashboard_setting_reset','Reset'); ?>" id="reset_ans_btn" onclick="resetAnswer()" class="btn btn-site">
...
?>
            <div class="settinbox" id="opass_div" style="display: none;">
              <div class="row">
                ...
                <div class="col-md-4" id="npass_div" style="display: none;">
                ...
                <div class="col-md-4" id="cpass_div" style="display: none;">
