...
<table id="exampleTabs" class="table">
<thead><tr><th><?php echo __('dashboard_myproject_client_project_name','Project Name'); ?></th><th class="text-center"><?php echo __('dashboard_myproject_client_project_type','Project Type'); ?></th><th class="text-center"><?php echo __('dashboard_myproject_client_bids','Bids'); ?></th><th class="text-center"><?php echo __('dashboard_myproject_client_workroom','Workroom'); ?></th><th class="text-center"><?php echo __('dashboard_myproject_posted_date','Posted date'); ?></th><th><?php echo __('dashboard_myproject_client_action','Action'); ?></th></tr>
</thead>
<tbody>
<?php
...
if($v['project_type'] == 'H' AND $v['multi_freelancer'] == 'Y'){
	$project_type='<span class="badge badge-info">'.__('dashboard_myproject_hourly','Hourly').'</span>';
}else{
	$project_type='<span class="badge badge-primary">'.__('dashboard_myproject_fixed','Fixed').'</span>';
}
