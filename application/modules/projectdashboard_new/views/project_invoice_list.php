...
<div class="dashboard-content-container">
    ...
    <div class="table-responsive">
        ...
        <thead>
        <tr>
            <th>Invoice Number</th> <th>Invoice type</th> <th>Date</th><th style='width: 28%'>From/To</th><th>Status</th><th>Action</th><th>Invoice</th>
        </tr>
        </thead>
        <tbody>
		...
		<tr>
		   ...
		   <a href="javascript:void(0)" onclick="confirm_first(this, 'accept')" data-invoice-id="<?php echo $v['invoice_id']; ?>" data-project-type="<?php echo $project_type; ?>" data-project-id="<?php echo $project_id; ?>">Accept</a> |
		   <a href="javascript:void(0)" onclick="confirm_first(this, 'cancel')" data-invoice-id="<?php echo $v['invoice_id']; ?>" data-project-type="<?php echo $project_type; ?>" data-project-id="<?php echo $project_id; ?>">Deny</a> 
...
<div id="requestModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Request</h4>
