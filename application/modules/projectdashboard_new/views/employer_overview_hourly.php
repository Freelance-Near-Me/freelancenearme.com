...
<div role="tabpanel" class="tab-pane active" id="overview">
	...
	<?php if($project_detail['status'] == 'S'){ ?>
		<div class="alert alert-warning">        	
        	Project has been stopped because you have not enough balance in your project deposit. Please add fund to your project deposit.            
        </div>
	<?php } ?>
	...
	<div class="row">
		<div class="col-sm-6">
			...
			?>
			<ul class="list-group">
				<li class="list-group-item">Total Deposited Amount <span class="badge pull-right"><?php echo CURRENCY.$total_deposit; ?></span></li>
				<li class="list-group-item">Total Fund Release <span class="badge pull-right"><?php echo CURRENCY.$total_release; ?></span></li>
				<li class="list-group-item">Total Fund Pending <span class="badge pull-right"><?php echo CURRENCY.$total_pending; ?></span></li>
				<li class="list-group-item"><b>Remaining Balance </b><span class="badge pull-right"><?php echo CURRENCY.$remaining_bal; ?></span></li>
			</ul>
		</div>
		<div class="col-sm-6">
			<?php if($project_detail['status'] != 'C'){ ?>
			<div class="add-fund-bx table">
				...
				<div class="add-fund-btn-bx">
					<p>Mimimum deposit : <b><i><?php echo CURRENCY.$min_deposit; ?></i></b></p>
					<p><b>Deposit Fund</b></p>
					<button class="btn btn-site" onclick="$('.add-fund-form-bx').fadeIn();">Add Project Fund</button>
				</div>
				
				<div class="add-fund-form-bx full-size" style="display:none;">
					<span class="cross-btn" onclick="$('.add-fund-form-bx').fadeOut();"><i class="icon-line-awesome-close"></i></span>
					...
					<form style="padding: 10px;" onsubmit="addProjectFund(this, event)" action="<?php echo base_url('projectdashboard_new/add_project_fund')?>">
						...
						?>
						<p>Current Account Balance : <span class="pull-right"><b><?php echo CURRENCY.$wallet_bal;?></b></span></p>
						<div class="input-group">
							
							<input type="text" name="amount" class="form-control" placeholder="Enter Amount ($)">
                            <input type="hidden" name="project_id" value="<?php echo $project_id; ?>"/>
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button">Add Fund</button>
                            </div>							
						</div>
					</form>
				</div>
		...
		if(file_exists('assets/uploaded/cropped_'.$f_logo)){
			...
			?>
			 <tr>
			   ...
			   <a title="Give bonus" href="javascript:void(0)" onclick="giveBonus('<?php echo $project_id?>', '<?php echo $v['freelancer_id'];?>');"><i class="zmdi zmdi-money zmdi-18x"></i></a> &nbsp; 
			   
			   <a href="javascript:void(0)" title="End Contract" onclick="endContractOpen(this);" data-freelancer-id="<?php echo $v['freelancer_id']; ?>" data-name="<?php echo $name; ?>"><i class="zmdi zmdi-close-circle zmdi-18x"></i></a> &nbsp; 
			   ...
			   <a href="<?php echo base_url('projectdashboard_new/view_contract/'.$project_id.'/'.$v['freelancer_id']); ?>">View Detail</a>
	...
	<h4>Project Activity: <?php if($project_detail['status'] == 'P'){ ?> <a href="javascript:void(0)" class="btn btn-site pull-right btn-sm" data-toggle="modal" data-target="#createActivityModal">Create Activity</a><?php } ?></h4>
...
<div id="msgModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Comment</h4>
...
<div id="createActivityModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title"><?php echo __('projectdashboard_create_activity','Create Activity'); ?></h4>
			...
			<form action="<?php echo base_url('projectdashboard/project_activity/'.$project_detail['project_id'].'?return=projectdashboard_new/employer/overview/'.$project_detail['project_id']);?>" method="post" id="create_activity_form">
				...
				<?php
					...
					<div class="checkbox checkbox-inline">					  
                      ...
                      <label for="activity_userN_<?php echo $user_detail['user_id']; ?>"><?php echo $user_detail["fname"].' '.$user_detail["lname"]; ?></label>
					</div>
					<?php 	} } ?>
...
<div class="modal fade" id="givebonus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title" id="myModalLabel"><?php echo __('projectdashboard_give_bonus','Give Bonus'); ?></h4>
      ...
      <form action="" name="givebonusform" class="form-horizontal givebonusform" method="POST">
       ...
       <button type="button" onclick="sendbonus()" id="sbmt" class="btn btn-site"><?php echo __('projectdashboard_send','Send'); ?></button>
       </form>
...
<div class="modal fade" id="contractModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	 ...
	 <div class="modal-header"><h4 class="modal-title" id="myModalLabel">End contract with VK Bishu </h4>
      ...
      <div class="modal-body" style="background-color:#f5f5f5">
        ...
        <div class="feedback">
			...
			<div class="form-group">
			<div class="col-xs-12">
				<label>What do you think are their strengths?</label><br />
			...
			<div class="form-group">
			<div class="col-xs-12">
				<label>Rate their english proficiency:</label><br />
...
<div class="modal fade" id="readReviewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	 <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Feedback By Vk Bishu</h4>
