...
<div role="tabpanel" class="tab-pane active" id="overview">
		...
		<button class="btn btn-site pull-right margin-bottom-10" id="send_invoice_btn" disabled>Send Invoice</button>
		
		<?php if(($project_detail['status'] == 'P') && ($is_project_running == 1) && ($project_schedule['manual_request_enable'] == 1)){ ?> <a href="javascript:void(0)" class="btn btn-site pull-right" data-toggle="modal" data-target="#manualHourModal" style="margin-right: 5px;">Request Manual Hour</a> <?php } ?> 
...
<div class="modal fade" id="manualHourModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:5%">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Send your work duration</h4>
       ...
       <div id="enquiry_form">
            ...
            <div class="form-group">
				...
				<div class="col-sm-4 col-xs-12">
                	<input type="number" class="form-control" placeholder="Total hour" required name="duration" value=""  max="<?php echo $bid_detail['available_hr']; ?>" onblur="checkRequestHour(this);" min="0"/>
               </div>
			   <div class="col-sm-4 col-xs-12">
...
<div id="activityModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Activity</h4>
...
<div id="infoModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Info</h4>
...
<div id="editHourModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Edit Hour</h4>
