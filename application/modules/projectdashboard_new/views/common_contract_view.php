...
<a class="btn btn-web" href="<?php echo base_url('projectdashboard_new/employer/overview/'.$project_id);?>"><i class="fa fa-arrow-left"></i> Back to Project Dashboard</a>
...
<div class="well margin-bottom-30">
	<div class="media">
        ...
        <div class="row">
        <div class="col-sm-6">
          <p><b>Hired : <?php echo CURRENCY.$bid_detail['bidder_amt'];?>/hr </b> &nbsp; <a href="#" class="toggle_edit"><i class="fas fa-pencil-alt"></i> Increase rate</a></p>
          <div class="edit_wrapper">
            <p><b>Edit hourly rate</b></p>
            <div class="input-group" style="max-width: 360px;">
                ...
                <div class="input-group-append">
                    <button class="btn btn-site" type="button" onclick="changeHourlyRate()" id="button-addon2">Save</button>
                </div>
            </div>
        ...
        <div class="col-sm-6">
          <p><b>Hired : <?php echo $bid_detail['available_hr'];?> hrs/week </b> &nbsp; <a href="#" class="toggle_edit"><i class="fas fa-pencil-alt"></i> Change limit</a></p>
          <div class="edit_wrapper">
            <p><b>Edit hour per week</b></p>
            <div class="input-group" style="max-width: 360px;">
                ...
                <div class="input-group-append"><button type="button" class="btn btn-site" onclick="changeHourLimit()">Save</button></div>
            </div>
          </div>
        </div>
        </div>
    ...
    <div class="buttonsOnly">
        ...
        <a class="btn btn-primary btn-sm" href="<?php echo base_url('message/browse/'.$project_id.'/'.$freelancer_id); ?>">Send message</a>
        <button class="btn btn-success btn-sm" onclick="giveBonus('<?php echo $project_id?>', '<?php echo $freelancer_id;?>');">Give bonus</button>
        <?php if($schedule['is_project_paused'] == 1){ ?>
        <button class="btn btn-primary btn-sm" onclick="pauseAction('<?php echo $schedule['schedule_id']?>', 0)">Start contract</button>
        <?php }else{ ?>
        <button class="btn btn-warning btn-sm" onclick="pauseAction('<?php echo $schedule['schedule_id']?>', 1)">Pause contract</button>
        <?php } ?>
        <button class="btn btn-danger btn-sm"  onclick="endContractOpen(this);" data-freelancer-id="<?php echo $freelancer_id; ?>" data-name="<?php echo $name; ?>">End contract</button>
        <?php if($schedule['manual_request_enable'] == 1){ ?>
        <button class="btn btn-danger btn-sm" onclick="freelancer_action('<?php echo $schedule['schedule_id']?>', 'manual_request_enable', 0);">Disallow manual time logging</button>
        <?php }else{ ?>
        <button class="btn btn-web btn-sm" onclick="freelancer_action('<?php echo $schedule['schedule_id']?>', 'manual_request_enable', 1);">Allow manual time logging</button>
        <?php } ?>
  ...
  <div class="row">
    <div class="col-md-3 col-xs-12">
      ...
      <a class="list-group-item <?php if($curr_method == 'view_contract'){?>active<?php }?>" href="<?php echo base_url('projectdashboard_new/view_contract/'.$project_id.'/'.$freelancer_id); ?>">Overview</a>
      <a class="list-group-item <?php if($curr_method == 'view_tracker'){?>active<?php }?>" href="<?php echo base_url('projectdashboard_new/view_tracker/'.$project_id.'/'.$freelancer_id); ?>">Work diary</a>
      </div>
    </div>
