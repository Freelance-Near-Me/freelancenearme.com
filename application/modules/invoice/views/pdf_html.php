...
<tfoot>
<tr><th colspan="{$extraRow}" style="padding: 8px;border-top: 1px solid #ccc;">Total Price ($c)</th><th style="padding: 8px;border-top: 1px solid #ccc;text-align:right;">{$total_amount}</th></tr>
</tfoot>
