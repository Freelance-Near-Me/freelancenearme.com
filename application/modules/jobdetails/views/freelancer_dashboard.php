...
?>
	...
	<article class="col-md-5 col-xs-12">
	<div class="dash_content4 text-center">  
       <a href="#" class="btn btn-primary" onclick="$('#activity-box').toggle(300);">View activity</a>
	   <div class="activity-box" id="activity-box" style="display:none;">
			...
			//get_print($activity);
			?>
			<ul class="list-group" style="overflow: auto;max-height:206px;margin: 15px 0 0;">
				...
				<?php if($v['approved'] == 'N'){ ?>
					<a href="<?php echo base_url('projecthourly/approve_activity/'.$v['id']).'?project='.$pid;?>" class="pull-right" style="padding: 0px 8px;"><i class="fa fa-thumbs-up" title="Approved"></i></a>
					<a href="<?php echo base_url('projecthourly/deny_activity/'.$v['id']).'?project='.$pid;?>" class="pull-right" style="color:#f00;padding: 0px 8px;"><i class="fa fa-thumbs-down" title="Deny"></i></a>
				<?php }else{ ?>
					<span class="pull-right" style="padding: 0px 8px;"><i class="fa fa-thumbs-up" title="Approved"></i></span>
				<?php } ?>
				</li>
				<?php } }else{ ?>
					No activity 
...
<table class="table table-dashboard">
    ...
    <tr>
        ...
        <td><?php echo $vals['hour'];?> hours </td>
        <td><?php echo CURRENCY;?><?php echo $client_amt;?></td> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" onclick="$('#myModal').modal('hide');" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">     
       ...
       <div id="enquiry_form">
            ...
            <div class="form-group">
                <label class="col-sm-4">Total hour:</label>       
            ...
            <div class="form-group">           
                <div class="col-sm-8 col-sm-offset-4 col-xs-12">
                    ...
                    <button type="button" class="btn btn-default pull-right" onclick="$('#myModal').modal('hide');" data-dismiss="modal">Close</button>  
                </div>
            </div>
            </form>
	   </div>                       
