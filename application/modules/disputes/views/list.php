...
<ul class="nav nav-tabs">
    <li class="nav-item"><a class="active" href="<?php echo VPATH?>disputes/">Disputes</a></li>
    <li class="nav-item"><a href="<?php echo VPATH?>disputes/closed">Closed Disputes</a></li>
</ul>
