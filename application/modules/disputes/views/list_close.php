...
<div class="col-md-9 col-sm-8 col-xs-12">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item"><a href="<?php echo VPATH?>disputes/">Disputes</a></li>
        <li class="nav-item"><a class="active" href="<?php echo VPATH?>disputes/closed">Closed Disputes</a></li>
    </ul>
...
<tbody>
<?php 
if(count($disput_list_close)>0){ 
foreach($disput_list_close as $row){ 
...
<tr>
<td>
<a href="javascript:void(0)">#<?php echo $row['id'];?>
</a>
</td>
<td>
<?php
