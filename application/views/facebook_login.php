<script type="text/javascript">
    (function(d, s, id){
        ...
        js.src = "https://connect.facebook.net/en_US/all.js#version=v3.1&appId=<?php echo get_option_value('facebook_appId')?>&status=true&cookie=true&xfbml=true";
				...
				$.ajax({
					...
					success: function(res){
						if(res.status == 1){
							...
							alert('Your account is close. Please contact to admin...');
							location.reload();
						}
					}
				});
