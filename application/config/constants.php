...
define('PROJECT', '');
define('URL',		'https://'.$_SERVER['HTTP_HOST'].PROJECT."/");
define('VPATH',		'https://'.$_SERVER['HTTP_HOST'].PROJECT."/");
define('APATH',		$_SERVER['DOCUMENT_ROOT'].PROJECT."/");
define('ASSETS',	URL."assets/");
define('CSS',		ASSETS."css/");
define('JS',		ASSETS."js/");
define('JSN',		ASSETS."jsn/");
...
foreach( $query->result() as $filed=>$val ){
    ...
    define('ADMIN_INSTAGRAM', $val->instagram);
	...
	define('STRIPE_MODE', $val->stripe_mode);
