...
<section id="content">
    <div class="wrapper">
        ...
        <div class="container-fluid">								
                <div class="text-right mb-2"><a href="javascript:void(0);" onclick="hdd();" data-reveal-id="exampleModal" class="btn btn-primary"><i class="la la-envelope"></i> Send Mail</a></div>
