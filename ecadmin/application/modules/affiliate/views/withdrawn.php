            ...
            <?php
                            if (count($all_data) > 0) {
                                ...
                                foreach ($all_data as $key => $val) {
                                    ...
                                    ?>
            <tr>
              <td><?= date('d-M-Y H:i:s',strtotime($val['transction_date'])); ?></td>
              <td> Transaction Id : <b></b><br />
                <?php 
              ...
              <td><?php 
                ...
                <?php
										...
										{
										?>
                <input type=checkbox name='approve[]' value="<?php echo $val['withdrawl_id'];?>">
                &nbsp;Approve 
                <!--<a href="paypal_transfer/<?php echo $val['withdrawl_id']?>" class="btn">Pay Now</a>   -->
                <?php
										}
										else
										{
