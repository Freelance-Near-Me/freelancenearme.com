...
class Designation extends MX_Controller {
    ...
    public function index() {
		...
		$data['all_data'] = $this->designation_model->getAllDesignationList();
		...
		if($this->input->post('submit'))
		{
            ...
            if ($this->form_validation->run() == FALSE) {
               ...
               // echo "<pre>";
                ...
                $insert_media = $this->designation_model->add($post_data);
                ...
                redirect(base_url() . 'designation/add');
            }
	...
	public function edit()
	{
		...
		if($id)
		{
			$data['all_data'] = $this->designation_model->getAllDesignationListbyId($id);
		...
		if($this->input->post('submit'))
		{
			...
			{
				$new_data['designation'] = $this->input->post('designation');
				$new_data['status'] = $this->input->post('status');
			$post_data['id'] = $id;
			$update = $this->designation_model->updateDesignation($new_data,$id);
			if ($update) {
	...
	public function change_status()
	{
		...
		{
			$update = $this->designation_model->deleteDesignation($id);	
		}
		else
		{
			$update = $this->designation_model->updateDesignation($data,$id);
		}
