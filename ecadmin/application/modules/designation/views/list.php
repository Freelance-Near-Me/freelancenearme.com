    ...
    <div class="wrapper">
        <div class="crumb">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="<?= base_url() ?>designation/">Designation List</a></li>
            </ul>
        </div>
                            ...
                            if (count($all_data) > 0) {
                                foreach ($all_data as $key => $val) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $val['id'] ?></td>
                                        <td><?= ucwords($val['designation']) ?></td>
                                        <td align="center">
                                            <?php
                                            if ($val['status'] == 'Y') {
                                                echo anchor(base_url() . 'designation/change_status/' . $val['id'] .'/inact', '&nbsp;', $atr4);
                                            } else {

                                                echo anchor(base_url() . 'designation/change_status/' . $val['id'] . '/act', '&nbsp;', $atr3);
                                            }
                                            ?>
                                        ...
                                        <td align="center">
                                           ...
                                           $atr2 = array('class' => 'i-highlight', 'title' => 'Edit');
                                            echo anchor(base_url() . 'designation/edit/' . $val['id'], '&nbsp;', $atr2);
                                            echo anchor(base_url() . 'designation/change_status/' . $val['id'] . '/' . 'del/', '&nbsp;', $attr);
                                            ?>
