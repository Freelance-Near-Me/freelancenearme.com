...
html {
	...
	background:radial-gradient(#00c290 20%, #00805f 100%);
}
body {
	background:none
}
...
<div class="container-fluid">    
    <div id="login">       	   	
        ...
        <center><img src="<?php echo IMAGE; ?>logo.png" alt="Admin" class="img-responsive"></center>  			
           ...
           <div id="log" class="active">                                                                    
            ...
            <button id="loginBtn" type="submit" class="btn btn-site btn-block mb-3">Login</button>                          
    </form>
	...
	<div id="forgot">                              
        ...
        <!--<h3 class="center text-uppercase">Forgot password</h3>-->
            ...
            <button type="submit" id="forgotBtn" class="btn btn-site btn-block mb-3">Recover my password</button>
