    ...
    <div class="container-fluid">
        <div id="login">
            <div class="login-wrapper" data-active="forgot">
               ...
               <?php  if ($up_logo != '') {?>
			   <img src="<?php echo SITE_URL . "assets/images/user1.png"; ?>" width="200" height="150" alt="Genyx admin" class="img-responsive" style="margin:-3px 0 -7px 67px;"><?php }?></a>
                <div id="log">
                    <div id="avatar">
                        <img src="<?php echo SITE_URL . "assets/images/user1.png"; ?>" alt="SuggeElson" class="img-responsive">
                    </div>
				...
				?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <button type="submit" id="forgotBtn" class="btn btn-site btn-block">Recover my password</button>
                            </div>
                        </div><!-- End .row-fluid  -->
                    </form>
                </div>
