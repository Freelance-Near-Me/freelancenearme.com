  ...
  <div class="wrapper">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Partner List</a></li>
      </ol>
    </nav>
      ...
      <table class="table table-hover table-bordered adminmenu_list">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center"><?php if($val['image']!='')
										{
								?>
              <img src="<?= SITE_URL?>assets/partner_image/<?=$val['image']?>" height="60" width="60"/>
              <?php
										}else{ ?>
            ...
            <td><?php echo ucwords($val['url']);?></td>
            <td align="center"><?php
				if ($val['status'] == 'Y') {
					echo anchor(base_url() . 'partner/change_status/' . $val['id'] .'/inact', '&nbsp;', $atr4);
				} else {

					echo anchor(base_url() . 'partner/change_status/' . $val['id'] . '/act', '&nbsp;', $atr3);
				}
				?></td>
            <td align="right"><?php
			   $atr2 = array('class' => 'la la-edit _165x', 'title' => 'Edit');
				echo anchor(base_url() . 'partner/edit/' . $val['id'], '&nbsp;', $atr2);
				echo anchor(base_url() . 'partner/change_status/' . $val['id'] . '/' . 'del/', '&nbsp;', $attr);
				?></td>
          </tr>
          <?php
				}
