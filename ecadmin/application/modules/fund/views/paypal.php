...
<section id="content">
    <div class="wrapper">
        ...
        <div class="container-fluid">          			
				...
				<?php
					$key = time().'_'.rand(11111111, 999999999);
					$this->session->set_userdata('txn_key' , $key);
					$return_url = VPATH . 'fund/payment_confirm/'.$w_id.'/'.$key;
					$cancel_url = VPATH . 'fund/payment_cancel/';
					$notify_url = VPATH . 'fund/paypal_notify/';
					$paypal_url = '';
				...
				<!--<form action="<?php echo base_url('fund/approvepay')?>" method="post">		-->
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
					<input type="text" id="required" value="<?php echo $paypal_acc; ?>" name="meta_title" class="required form-control" readonly>
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
					<input type="text" id="required" value="<?php echo $amount_paid; ?>" name="meta_title" class="required form-control" readonly>
						
					</div>
				</div>	
				<!--<input type="hidden" name="approve[]" value="<?php echo $w_id?>"/>-->
				
				<div class="form-group">
					<div class="col-lg-offset-2">
						<div class="pad-left15">
							<button type="submit" class="btn btn-primary">Pay</button>
							<button type="button" onclick="redirect_to('<?php echo base_url().'fund/withdraw'; ?>');" class="btn">Cancel</button>
						</div>
					</div>
				</div>
