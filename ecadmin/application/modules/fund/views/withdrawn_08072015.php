    ...
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Withdrawn History </h1>
            </div>
            <div class="row">
...
<?php
										...
										{
										?>                                        
                                        <!--<input type=checkbox name='approve<?php echo $p++;?>' value="<?php echo $val['withdrawl_id'];?>">&nbsp;Approve-->             
