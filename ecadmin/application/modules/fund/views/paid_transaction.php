    ...
    <div class="wrapper">
        <div class="crumb">
            <ol class="breadcrumb">
                ...
                <li>Paid Transaction History</li>
            </ol>
        </div>
        ...
        <div class="container-fluid">
				...
				?>
						...
						<div class="row">
							<div class="col-lg-2">
									Date From
									<input type="text" id="datepicker_from" name="from_txt" readonly="readonly" size="15" style="margin-right: 6px;"  value="<?php echo !empty($srch['from_txt']) ? $srch['from_txt'] : set_value('from_txt');?>"/>
							</div>
							<div class="col-lg-2">
								Date To
								<input type="text" id="datepicker_to" name="to_txt" readonly="readonly" size="15" style="margin-right: 6px;"  value="<?php echo !empty($srch['to_txt']) ? $srch['to_txt'] : set_value('to_txt');?>"/>
							</div>
							<div class="col-lg-4">
								User Name / Name / Email
								<input type="text" class="form-control" value="<?php echo !empty($srch['uname']) ? $srch['uname'] : '';?>" name="uname"/>
							</div>
							<div class="col-lg-2 hidden">
								User Email
								<input type="text" class="form-control" value="<?php echo !empty($srch['uemail']) ? $srch['uemail'] : '';?>" name="uemail"/>
							</div>
						
							<div class="col-lg-4">
								<input type="submit" name='submit' id="submit" class="btn" value="SEARCH" style="margin-top:20px">
								<?php 
								$srch_query_string = !empty($srch) ? '?'.http_build_query($srch) : '';
								?>
								<a href="<?php echo base_url('fund/exportPaidTxn').$srch_query_string;?>" class="btn btn-info" style="margin-top:20px">Export</a>
                    ...
                    <table class="table table-hover table-bordered adminmenu_list" id="example1">
                        <thead>  	
                            <tr>
                                ...
                                <th id="stt">Status</th>
								<th id="stt">Approved By</th>
								
								<th id="stt">Payment</th>
