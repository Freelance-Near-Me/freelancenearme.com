...
class Dashboard extends MX_Controller {
    ...
    public function index() {
		...
		$data['total_registration_2']=$this->user_model->registration_status('',date('Y-m',strtotime('-2 month')));
		$data['f_registration_2']=$this->user_model->registration_status('F',date('Y-m',strtotime('-2 month')));
		$data['e_registration_2']=$this->user_model->registration_status('E',date('Y-m',strtotime('-2 month')));
		$data['total_registration_1']=$this->user_model->registration_status('',date('Y-m',strtotime('first day of last month')));
		$data['f_registration_1']=$this->user_model->registration_status('F',date('Y-m',strtotime('first day of last month')));
		$data['e_registration_1']=$this->user_model->registration_status('E',date('Y-m',strtotime('first day of last month')));
		$data['total_registration_current']=$this->user_model->registration_status('',date('Y-m'));
		$data['f_registration_current']=$this->user_model->registration_status('F',date('Y-m'));
		$data['e_registration_current']=$this->user_model->registration_status('E',date('Y-m'));
