     ...
     <div class="row">
      <!------------- MEMBER STATISTIC START  ------------------>
        <div class="col-md-6" >
            <div class="card pull-up">
                ...
                <div class="card-body" style="min-height:213px">
					<?php $total_member_view = $total_member; if(!$total_member){ $total_member = 1; }?>
                    <div class="campaign-stats center" style="border-top:none;">
                        <div class="items">
                            <a href='<?php echo base_url().'member/member_list'?>'>
								<div class="percentage" data-percent="100"><span>100</span></div>
							</a>
                            <div class="txt">Total <?php echo $total_member_view;?></div>
                        </div>
						<div class="items">
							<a href='<?php echo base_url().'member/member_list?status=Y'?>'>
						...
						<div class="items">
							<a href='<?php echo base_url().'member/member_list?status=S'?>'>
						...
						<div class="items">
							<a href='<?php echo base_url().'member/member_list?status=N'?>'>
			...
			<div class="card pull-up">
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><?=date('F Y',strtotime('first day of last month'))?></a>
                ...
                <div class="tab-content" id="nav-tabContent" style="border:none; margin-top:12px">
                  ...
                  <div class="stats-buttons">
                    <ul class="list-unstyled">
                        <li>
                            <a href="<?php echo base_url().'member/member_list?reg_date='.date('F Y',strtotime('-2 month'))?>" class="clearfix">
                        ...
                        <li>
                            <a href="<?php echo base_url().'member/member_list?account_type=F & reg_date='.date('F Y',strtotime('-2 month'))?>" class="clearfix">
                                <span class="icon redBG"><i class="la la-money"></i></span>
                                <span class="number"><?php echo $f_registration_2;?></span>
                                <span class="txt">Freelancer</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url().'member/member_list?account_type=E & reg_date='.date('F Y',strtotime('-2 month'))?>" class="clearfix">
                                <span class="icon greenBG"><i class="la la-frown-o"></i></span>
                                <span class="number"><?php echo $e_registration_2;?></span>
                  ...
                  <div class="stats-buttons">
                        <ul class="list-unstyled">
                            <li>
                                <a href="<?php echo base_url().'member/member_list?reg_date='.date('F Y',strtotime('first day of last month'))?>" class="clearfix">
                                    <span class="icon orangeBG"><i class="la la-user"></i></span>
                            ...
                            <li>
                                <a href="<?php echo base_url().'member/member_list?account_type=F & reg_date='.date('F Y',strtotime('first day of last month'))?>" class="clearfix">
                                    <span class="icon redBG"><i class="la la-money"></i></span>
                                    <span class="number"><?php echo $f_registration_1;?></span>
                                    <span class="txt">Freelancer</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url().'member/member_list?account_type=E & reg_date='.date('F Y',strtotime('first day of last month'))?>" class="clearfix">
                                    <span class="icon greenBG"><i class="la la-frown-o"></i></span>
                                    <span class="number"><?php echo $e_registration_1;?></span>
                                    <span class="txt">Employer</span>
                                </a>
                            </li>
                        </ul>
                  ...
                  <div class="stats-buttons">
                    <ul class="list-unstyled">
                        <li>
                            <a href="<?php echo base_url().'member/member_list?reg_date='.date('F Y')?>" class="clearfix">
                                <span class="icon orangeBG"><i class="la la-user"></i></span>
                        ...
                        <li>
                            <a href="<?php echo base_url().'member/member_list?account_type=F & reg_date='.date('F Y')?>" class="clearfix">
                                <span class="icon redBG"><i class="la la-money"></i></span>
                                <span class="number"><?php echo $f_registration_current;?></span>
                                <span class="txt">Freelancer</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url().'member/member_list?account_type=E & reg_date='.date('F Y')?>" class="clearfix">
                                <span class="icon greenBG"><i class="la la-frown-o"></i></span>
                                <span class="number"><?php echo $e_registration_current;?></span>
                                <span class="txt">Employer</span>
                            </a>
                        </li>
                    </ul>
        ...
        <!-------- MEMBER GRAPH END --------->
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="card pull-up" style="height: 100%;">
                        <div class="card-header">                            
                        ...
                        <div class="card-body">
							<?php $total_project_view = $total_project;  if(!$total_project){ $total_project = 1; }?>
                            <div class="campaign-stats center" style="border-top:none;">
							
								<div class="items">
									<div style="margin: 0 auto;" class="percentage" data-percent="100"><span>100</span></div>
									<div class="txt">Total Project <?php echo $total_project_view;?></div>
								</div>
								
								<a href="<?php echo base_url('project/open')?>" class="text-dark">
								<div class="items">
									<div style="margin: 0 auto;" class="percentage-green" data-percent="<?php echo ($open_project/$total_project)*100;?>"><span><?php echo floor(($open_project/$total_project)*100);?></span>%</div>
									<div class="txt">Open Project <?php echo $open_project;?></div>
								</div>
								</a>
								
								<div class="items" style="display:none;">
									<div style="margin: 0 auto;" class="percentage" data-percent="<?php echo ($frozen_project/$total_project)*100;?>"><span><?php echo floor(($frozen_project/$total_project)*100);?></span>%</div>
									<div class="txt">Frozen Project <?php echo $frozen_project;?></div>
								</div>
								
								<a href="<?php echo base_url('project/process')?>" class="text-dark">
								<div class="items">
									<div style="margin: 0 auto;" class="percentage" data-percent="<?php echo ($working_project/$total_project)*100;?>"><span><?php echo floor(($working_project/$total_project)*100);?></span>%</div>
									<div class="txt">Working Project <?php echo $working_project;?></div>
								</div>
								</a>
								
								<a href="<?php echo base_url('project/complete')?>" class="text-dark">
								<div class="items">
									<div style="margin: 0 auto;" class="percentage" data-percent="<?php echo ($complete_project/$total_project)*100;?>"><span><?php echo floor(($complete_project/$total_project)*100);?></span>%</div>
									<div class="txt">Complete Project <?php echo $complete_project;?></div>
								</div>
								</a>
								
								<a href="<?php echo base_url('project/expire')?>" class="text-dark">
								<div class="items">
									<div style="margin: 0 auto;" class="percentage-red" data-percent="<?php echo ($expire_project/$total_project)*100;?>"><span><?php echo floor(($expire_project/$total_project)*100);?></span>%</div>
