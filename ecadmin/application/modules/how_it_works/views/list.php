<section id="content">
	...
	<nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">How it Works List</a></li>
      </ol>
    </nav>
                ...
                if (count($all_data) > 0) {
                    foreach ($all_data as $key => $val) {
                        ...
                        <tr>
                            ...
                            <td><?= $val['icon_class'];?></td>
                            <td align="center">
                                <?php
                                if ($val['status'] == 'Y') {
                                    echo anchor(base_url() . 'how_it_works/change_status/' . $val['id'] .'/inact', '&nbsp;', $atr4);
                                } else {

                                    echo anchor(base_url() . 'how_it_works/change_status/' . $val['id'] . '/act', '&nbsp;', $atr3);
                                }
                                ?>
                            </td>
                            <td align="right">
                                ...
                                echo anchor(base_url() . 'how_it_works/edit/' . $val['id'], '&nbsp;', $atr2);
                                echo anchor(base_url() . 'how_it_works/change_status/' . $val['id'] . '/' . 'del/', '&nbsp;', $attr);
                                ?>
                            </td>
                        </tr>
                        <?php
