      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form id="validate" action="<?php echo base_url(); ?>membership_plan/add_membership_plan/" class="form-horizontal" role="form" name="state" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="userfile">Plan Icon</label>
              <div class="col-lg-6">
            ...
            <div class="form-group">
              ...
              <label class="checkbox-inline">
                <input class="form-control" type="radio" id="status" name="status" value="Y" />
                Online
                <input class="form-control" type="radio" id="status" name="status" Value="N" />
                Offline </label>
            </div>
