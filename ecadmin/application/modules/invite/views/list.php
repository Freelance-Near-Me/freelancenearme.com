...
<section id="content">
    <div class="wrapper">
        <div class="crumb">
			...
			<li class="active">Invite User List</li>
        ...
        <div class="container-fluid">				
				...
				<tr>
                <td align="left">
				<a href="<?php echo base_url();?>invite/generatechkCSV"><input class="btn btn-default" type="button" value="Generate CSV"></a>
				</td>
...
<?php
		...
		foreach ($list as $key => $con) {
				$uid=$this->auto_model->getFeild('user_id','user','email',$con['email']);
				...
				?>
                                <tr>
                                    ...
                                    <td><?php echo $con['fname']; ?></td>
                                    <td align="center"><?php echo $con['femail']; ?></td>
									<td align="center"><?php echo $con['name']; ?><br />
                                    <?php
                                    if($uid>0)
									{
									...
									<td align="center"><?php echo $con['email']; ?></td>
									...
									<td align="center">
										...
										if ($con['reg_status'] == 'Y') {
										?>
                                        <a href="javascript:void(0)" class="i-checkmark-3 green" title="Active">&nbsp;</a>
                                        <?php
									
										} else {
									
										?>
                                        <a href="javascript:void(0)" class="i-checkmark-3 red" title="Inactive">&nbsp;</a>
                                        <?php
										}
                                    ...
                                    <td align="center">
                                    <input type="checkbox" name="mailsend" id="mail_<?php $con['id'];?>" value="<?php echo $con['id'];?>" class="mailcheck" title="please check to send mail"/> | <?php echo anchor(base_url() . 'invite/delete/' . $con['id'], '&nbsp;', $attr);?>
                                    </td>
                                </tr>
