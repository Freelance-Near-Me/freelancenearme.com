...
<script>
    ...
    function getAllRecords(letter) {
       ...
       // var page = $("#page").val();
        ...
        var url = basepath + "member/member_list/" +letter;
  ...
  <div class="container-fluid">    
    ...
    <div class="row">
      ...
      <h4>Member List</h4>
      <?php /* <form action="<?= base_url() ?>member/page" method="post" class="hidden">
		...
		<a href="<?php echo base_url();?>member/member_list" class="btn btn-site">All</a>
		<a href="<?php echo base_url();?>member/member_list?account_type=F" class="btn btn-site">Freelancer(<?php echo $f_total?>)</a>
		<a href="<?php echo base_url();?>member/member_list?account_type=E" class="btn btn-site">Employer(<?php echo $e_total?>)</a>
        ...
        ?>
            ...
            <div class="custom-control custom-checkbox">
              ...
              <td><?php if($user['logo']!='')
                ...
                <?php /* <td><?php echo date('d-M-Y H:i:s',strtotime($user['edit_date'])); ?></td> */ ?>
                <td><?php
