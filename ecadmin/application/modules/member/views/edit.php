...
?>
      <div class="panel panel-default">
        ...
        <div class="col-lg-10 col-md-9">
            ...
            {
            ?>
                <img style='width: 150px' src="<?php echo SITE_URL;?>assets/uploaded/<?php echo $all_data['logo'];?>" />
                <?php
            }
            else
            {
            ?>
                <img style='width: 150px' src="<?php echo SITE_URL;?>assets/user_images/default_profile_pic.jpg" height="60" width="60"/>
                <?php
            }
            ?>
