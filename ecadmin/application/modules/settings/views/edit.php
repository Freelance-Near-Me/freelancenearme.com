      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body"> <?php echo validation_errors('<div class=" red alert ">', '</div>'); ?>
          <form id="validate" action="<?php echo base_url(); ?>settings/edit/1" class="form-horizontal" enctype="multipart/form-data" role="form" name="settings" method="post">
			...
			<div class="row">
              <label class="col-md-3 control-label" for=" ">Instagram</label>
              <div class="col-md-9">
                <input type="url" id=" " value="<?php echo $all_data['instagram']; ?>"  name="instagram" class="  form-control">
                <?php echo form_error('instagram', '<label class="error" for=" ">', '</label>'); ?> </div>
            </div>
            <div class="row">
			...
			<div class="row">
              <label class="col-md-3 control-label" for="agree">Bid List Visibility</label>
              <div class="col-md-9">
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" class="custom-control-input" id="bid_view_public" name="bid_view" value="1" checked="checked">
                  <label class="custom-control-label" for="bid_view_public">Public</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" class="custom-control-input" id="bid_view_private" <?php if (isset($all_data['bid_view']) && $all_data['bid_view'] == '0') {	echo "checked";	} ?> name="bid_view" value="0">
                  <label class="custom-control-label" for="bid_view_private">Private</label>
                </div>
              </div>
            </div>
