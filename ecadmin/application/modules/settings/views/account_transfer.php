          ...
          <form id="validate" action="<?php echo base_url(); ?>settings/transfer_edit/1" class="form-horizontal"  role="form" name="settings" method="post">
            <div class="form-group">
              <table border="0" cellpadding="4" cellspacing="1" width="100%" bgcolor="">
                <tbody>
				  <tr class="lnk">
                    <td valign="top" width="25%"><b> Stripe Environment :</b></td>
                    <td><div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" id="customRadioInline3" name="stripe_mode" value="DEMO" <?php if($all_data['stripe_mode']=="DEMO") { echo "checked"; } ?>>
                        <label class="custom-control-label" for="customRadioInline3">Demo</label>
                      </div>
                      <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" id="customRadioInline4" name="stripe_mode" value="LIVE" <?php if($all_data['stripe_mode']=="LIVE") { echo "checked"; } ?>>
                        <label class="custom-control-label" for="customRadioInline4">Live</label>
                      </div>
                      <p><?php echo form_error('stripe_mode', '<label class="error" for="required">', '</label>'); ?></p></td>
                  </tr>
                  <tr>
