...
<nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a>Settings Options Details</a> </li>        
        </ol>
	</nav> 
...
<div class="col-sm-12">	
	...
	<table class="table table-hover adminmenu_list">
		<thead>
			<tr>
				<th>#</th>
				<th>Settings Options Key</th>
				<th>Settings Options Value</th>
		...
		<tbody>
			...
			if(count($list)!==0) {
				...
				<tr>
					...
					<td align="center"><?php  echo $sitemap['option_id'];?></td>
					<td><?php echo $sitemap['setting_key']; ?></td>
					<td><?php echo $sitemap['setting_value']; ?></td>
					...
					<td align="right">
						...
						echo anchor(base_url() . 'site_options/edit/' . $sitemap['option_id'], '&nbsp;', $atr2);
