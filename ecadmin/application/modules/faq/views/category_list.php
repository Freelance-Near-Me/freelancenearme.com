...
<section id="content">
	...
	<nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo base_url() . 'faq/add_category'; ?>">Add Category</a></li>      
        <li class="breadcrumb-item active"><a>Category list</a></li>
      </ol>
    </nav> 
        <div class="container-fluid">            
					<div class="text-right mb-2"><a href="<?=base_url().'faq/add_category'?> " class="btn btn-primary"><i class="la la-plus"></i> Add Category</a></div>
		<?php
    ...
    ?>
                            <tr onClick="displaySubadminmenu(<?php echo $menu['id']; ?>);" class="pointer_class">
                                    ...
                                    <td align="center">
                                        <?php
                                         if ($menu['status'] == 'Y') {
										echo anchor(base_url() . 'faq/change_category_status/' . $menu['id'].'/inact/'.$menu['status'], '&nbsp;', $atr4);
									
										} else {
									
										echo anchor(base_url() . 'faq/change_category_status/' . $menu['id'].'/act/'.$menu['status'], '&nbsp;', $atr3);
										}
                                        ?>
                                    </td>
                                    <td align="right"><?php
                                    ...
                                    echo anchor(base_url() . 'faq/edit_category/' . $menu['id'], '&nbsp;', $atr2);
                                    echo anchor(base_url() . 'faq/delete_category/' . $menu['id'], '&nbsp;', $attr);
                                        ?>
                                    </td>
                                </tr>
