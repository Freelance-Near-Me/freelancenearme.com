  ...
  <div class="wrapper">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="<?php echo base_url() . 'knowledge/category_list'; ?>">Category list</a></li>
    ...
    <div class="container-fluid">
      <div class="panel panel-default">
        <div class="panel-heading">          
          <h5><i class="la la-plus-square"></i> Add Knowledge Category</h5>
          <a href="#" class="minimize2"></a> </div>        
        <div class="panel-body"> <?php echo validation_errors('<div class=" red alert ">', '</div>'); ?>
          <form id="validate" action="<?php echo base_url(); ?>knowledge/add_category" class="form-horizontal" role="form" name="adminmenu" method="post">
            <?php
                    ...
                    if ($p_id != '') {
                        $p_name = $this->auto_model->getFeild('name', 'knowledge_type', 'id', $p_id);
                        ?>
            ...
            <?php } ?>
            <div class="form-group">
              <label class="col-form-label" for="required">Category Name</label>
