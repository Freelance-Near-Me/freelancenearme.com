...
<div class="wrapper">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a><?php echo $title; ?></a></li>
    </ol>
  </nav>
  <div class="container-fluid">
		
		<?php if($type == 'member_graph_chart'){ ?>
		...
		<?php }else if($type=='project_graph_chart'){ ?>
   ...
   /*  { data: frozen, label: "Frozen Project", color: "#dfc"}, */
    ...
    plot.highlight(item.series, item.datapoint);
		...
		<?php }else if($type=='finance_graph_chart'){ ?>
