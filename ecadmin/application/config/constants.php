...
define('PROJECT',		'');
define('URL',		'https://'.$_SERVER['HTTP_HOST'].PROJECT."/ecadmin/");

define('VPATH',		'https://'.$_SERVER['HTTP_HOST'].PROJECT."/ecadmin/");

define('APATH',		$_SERVER['DOCUMENT_ROOT'].PROJECT."/ecadmin/"); 
...
define('SITE_URL',      'https://'.$_SERVER['HTTP_HOST'].PROJECT."/");
