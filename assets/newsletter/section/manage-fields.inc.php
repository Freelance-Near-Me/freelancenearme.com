...
/*
	...
	$Id: manage-fields.inc.php 492 2009-12-06 18:22:36Z matt.simpson $
*/
...
$SIDEBAR[$i] .= "</tr>\n";
$SIDEBAR[$i] .= "<tr>\n";
$SIDEBAR[$i] .= "	<td><img src=\"./images/hotscripts.gif\" width=\"16\" height=\"16\" alt=\"HotScripts.com\" title=\"HotScripts.com\" /></td>\n";
$SIDEBAR[$i] .= "	<td><a href=\"http://www.hotscripts.com/?RID=9600\" target=\"_blank\">Visit HotScripts</a></td>\n";
$SIDEBAR[$i] .= "</tr>\n";
$SIDEBAR[$i] .= "</table>\n";

$ACTION				= "";
$ACTIONS_AVAILABLE	= array("add", "edit", "delete", "view", "update");
$PROCESSED			= array();
$CFIELDS_ID			= 0;

if((isset($_GET["action"])) && (in_array(trim($_GET["action"]), $ACTIONS_AVAILABLE))) {
	$ACTION = clean_input($_GET["action"]);
} elseif((isset($_POST["action"])) && (in_array(trim($_POST["action"]), $ACTIONS_AVAILABLE))) {
...
switch($ACTION) {
	case "add" :
		...
		if($_POST) {
			if((isset($_POST["field_type"])) && (trim($_POST["field_type"]) == "")) {
				$ERROR++;
		...
		<?php echo display_notice(array("After this custom field has been added to ListMessenger, do not forget to update the HTML form on your website so subscribers can successfully complete it.")); ?>
		...
		<tbody>
			<tr>
				...
				<td>
					...
					<option value="checkbox"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "checkbox")) ? " selected=\"selected\"" : "") ?>>Checkbox</option>
					<option value="hidden"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "hidden")) ? " selected=\"selected\"" : "") ?>>Hidden Field</option>
					<option value="linebreak"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "linebreak")) ? " selected=\"selected\"" : "") ?>>Linebreak</option>
					<option value="radio"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "radio")) ? " selected=\"selected\"" : "") ?>>Radio Buttons</option>
					<option value="select"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "select")) ? " selected=\"selected\"" : "") ?>>Select Box</option>
					<option value="textarea"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "textarea")) ? " selected=\"selected\"" : "") ?>>Textarea</option>
					<option value="textbox"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "textbox")) ? " selected=\"selected\"" : "") ?>>Textbox</option>
					</select>
				</td>
			</tr>
		</tbody>
		<tbody id="toggle-field_sname" style="display: none">
			<tr>
				...
				<td><input type="text" class="text-box" style="width: 175px" name="field_sname" value="<?php echo ((isset($_POST["field_sname"])) ? checkslashes($_POST["field_sname"], 1) : ""); ?>" maxlength="16" /></td>
			</tr>
		</tbody>
		<tbody id="toggle-field_lname" style="display: none">
			<tr>
				...
				<td><input type="text" class="text-box" style="width: 360px" name="field_lname" value="<?php echo ((isset($_POST["field_lname"])) ? checkslashes($_POST["field_lname"], 1) : ""); ?>" maxlength="64"/></td>
			</tr>
		</tbody>
		<tbody id="toggle-field_options" style="display: none">
			<tr>
				...
				<td><textarea name="field_options" style="width: 360px; height: 125px"><?php echo ((isset($_POST["field_options"])) ? checkslashes($_POST["field_options"], 1) : ""); ?></textarea></td>
			</tr>
		</tbody>
		<tbody id="toggle-field_length" style="display: none">
			<tr>
				...
				<td><input type="text" class="text-box" style="width: 50px" name="field_length" value="<?php echo ((isset($_POST["field_length"])) ? checkslashes($_POST["field_length"], 1) : 32); ?>" maxlength="4" /></td>
			</tr>
		</tbody>
		<tbody id="toggle-field_req" style="display: none">
			<tr>
				...
				<td>
					...
					<option value="0"<?php echo (((isset($_POST["field_req"])) && ($_POST["field_req"] == "0")) ? " selected=\"selected\"" : ""); ?>>No</option>
					<option value="1"<?php echo (((isset($_POST["field_req"])) && ($_POST["field_req"] == "1")) ? " selected=\"selected\"" : ""); ?>>Yes</option>
					</select>
				</td>
			</tr>
		</tbody>
	...
	break;
	case "edit" :
		if((isset($_GET["id"])) && (!$CFIELDS_ID = clean_input($_GET["id"], array("trim", "int")))) {
			$ERROR++;
			...
			if($result) {
				...
				<?php echo display_notice(array("After this custom field has been modified, please do not forget to update the HTML form on your website so subscribers can successfully complete it.")); ?>
				<?php echo (($ERROR > 0) ? display_error($ERRORSTR) : "") ?>
				...
				<tbody>
					<tr>
						...
						<td>
							<select id="field_type" name="field_type" style="width: 180px" onchange="custom_field_options(this.options[this.selectedIndex].value)">
							<option value="checkbox"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "checkbox")) ? " selected=\"selected\"" : (($result["field_type"] == "checkbox") ? " selected=\"selected\"" : "")) ?>>Checkbox</option>
							<option value="hidden"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "hidden")) ? " selected=\"selected\"" : (($result["field_type"] == "hidden") ? " selected=\"selected\"" : "")) ?>>Hidden Field</option>
							<option value="linebreak"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "linebreak")) ? " selected=\"selected\"" : (($result["field_type"] == "linebreak") ? " selected=\"selected\"" : "")) ?>>Linebreak</option>
							<option value="radio"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "radio")) ? " selected=\"selected\"" : (($result["field_type"] == "radio") ? " selected=\"selected\"" : "")) ?>>Radio Buttons</option>
							<option value="select"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "select")) ? " selected=\"selected\"" : (($result["field_type"] == "select") ? " selected=\"selected\"" : "")) ?>>Select Box</option>
							<option value="textarea"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "textarea")) ? " selected=\"selected\"" : (($result["textarea"] == "checkbox") ? " selected=\"selected\"" : "")) ?>>Textarea</option>
							<option value="textbox"<?php echo (((isset($_POST["field_type"])) && ($_POST["field_type"] == "textbox")) ? " selected=\"selected\"" : (($result["field_type"] == "textbox") ? " selected=\"selected\"" : "")) ?>>Textbox</option>
							</select>
						</td>
					</tr>
				</tbody>
				<tbody id="toggle-field_sname" style="display: none">
					<tr>
						...
						<td><input type="text" class="text-box" style="width: 175px" name="field_sname" value="<?php echo html_encode(((isset($_POST["field_sname"])) ? checkslashes($_POST["field_sname"], 1) : $result["field_sname"])); ?>" maxlength="16" /></td>
					</tr>
				</tbody>
				<tbody id="toggle-field_lname" style="display: none">
					<tr>
						...
						<td><input type="text" class="text-box" style="width: 360px" name="field_lname" value="<?php echo html_encode(((isset($_POST["field_lname"])) ? checkslashes($_POST["field_lname"], 1) : $result["field_lname"])); ?>" maxlength="64"/></td>
					</tr>
				</tbody>
				<tbody id="toggle-field_options" style="display: none">
					<tr>
						...
						<td><textarea name="field_options" style="width: 360px; height: 125px"><?php echo html_encode(((isset($_POST["field_options"])) ? checkslashes($_POST["field_options"], 1) : $result["field_options"])); ?></textarea></td>
					</tr>
				</tbody>
				<tbody id="toggle-field_length" style="display: none">
					<tr>
						...
						<td><input type="text" class="text-box" style="width: 50px" name="field_length" value="<?php echo html_encode(((isset($_POST["field_length"])) ? checkslashes($_POST["field_length"], 1) : $result["field_length"])); ?>" maxlength="4" /></td>
					</tr>
				</tbody>
				<tbody id="toggle-field_req" style="display: none">
					<tr>
						...
						<td>
							<select name="field_req" style="width: 54px">
							<option value="0"<?php echo (((isset($_POST["field_req"])) && ($_POST["field_req"] == "0")) ? " selected=\"selected\"" : (($result["field_req"] == "0") ? " selected=\"selected\"" : "")); ?>>No</option>
							<option value="1"<?php echo (((isset($_POST["field_req"])) && ($_POST["field_req"] == "1")) ? " selected=\"selected\"" : (($result["field_req"] == "1") ? " selected=\"selected\"" : "")); ?>>Yes</option>
							</select>
						</td>
					</tr>
				</tbody>
	...
	case "view" :
		switch($_GET["mode"]) {
			case "html" :
				...
				<br /><br />
				<?php
				echo display_notice(array("Please do not forget to replace the &quot;ENTER_GROUP_ID_HERE&quot; string in the form below with the actual ID of the group you would like your subscriber inserted to. To see the actual &quot;Group ID&quot; click <a href=\"index.php?section=manage-groups\">Manage Groups</a>."));
	...
	default :
		...
		if($ACTION == "update") {
			...
			if((isset($_POST["required"])) && (is_array($_POST["required"])) && (count($_POST["required"]))) {
				/**
				 * Update the static first and lastname preferences.
				 */
				if((isset($_POST["required"]["static"])) && (is_array($_POST["required"]["static"])) && (count($_POST["required"]["static"]))) {
					/**
				...
				if((isset($_POST["required"]["cfield"])) && (is_array($_POST["required"]["cfield"])) && (count($_POST["required"]["cfield"]))) {
					/**
					 * Now go through and make the checked options required.
					 */
